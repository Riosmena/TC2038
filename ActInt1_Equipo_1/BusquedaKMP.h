// ====================================================
// Archivo: BusquedaKMP.h
// Descripción: Se realiza una búsqueda del código
//             malicioso en cada archivo de transmisión
//             y muestra el resultado de la búsqueda,
//             en caso de ser encontrado imprime
//             tambien la posicion.
...
/*
La función buscarCodigoEnLinea se encarga de buscar el codigo malicioso
 ...
 */
int buscarCodigoEnLinea(const string &textoTransmision, const string &codigoMalicioso)
{
...
/*
La funcion buscarCodigoEnArchivo coordina la búsqueda del código malicioso en el archivo de transmisión y utiliza la
función buscarCodigoEnLinea para realizar la búsqueda en cada línea del archivo
 */
bool buscarCodigoEnArchivo(const string &archivoTransmision, const string &archivoCodigo)
{
    ...
    // Llama a buscarCodigoEnLinea con el texto completo
    int resultado = buscarCodigoEnLinea(textoTransmision, codigoMalicioso);
